  ...
  return (
    <div className="analysis-page">
      <header className="hero-section">
        <Typography variant="h2" className="hero-title">Resume Analysis</Typography>
        <Typography variant="h4" className="hero-subtitle">AI-Powered Job Fit Analysis</Typography>
      </header>
